...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="receiver.css"/>					<!-- Links the css file -->
    ...
    <div class="btn-group">
        <a href="reciever.php" class="btn btn-primary">Request Blood</a>    <!--For contacting -->
    </div>
    <div class="btn-group">
  ...
  <h2>Blood Types</h2>
  <hr>
  <p>Generally hospitals have following type of bloods.</p>
  <ul>
    <li>A+</li>
    <li>A-</li>
    <li>B+</li>
  ...
  <h2>Request Blood</h2>
  <hr>
  <p>You can find the blood <a href="#" style="color: red;">here.</a></p>
