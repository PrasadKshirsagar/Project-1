...
<html>
	...
	<body>
	  ...
	  <div class="btn-group btn-group-lg btn-group-justified">
	    <div class="btn-group">
        <a href="#" button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-user"></span>Hello Hospital</button></a>  <!--For sign Up It will open into a sign up form -->
      </div>
	    <div class="btn-group">
	      <a href="about.php" type="button" class="btn btn-primary">WHO</a>
	    </div>
      <div class="btn-group">
        <a href="#" class="btn btn-primary">Update Information</a>    <!--For contacting -->
    </div>
	    <div class="btn-group">
        <a href="#" class="btn btn-primary">Appointments</a>    <!--For contacting -->
    </div>
      <div class="btn-group">
